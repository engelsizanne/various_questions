...
public class P09_JListKullanimi extends javax.swing.JFrame  {DefaultListModel model = new DefaultListModel();
...
public P09_JListKullanimi() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P09_JListKullanimi.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new P09_JListKullanimi().setVisible(true);
            }
        });
    }
